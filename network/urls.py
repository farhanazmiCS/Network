...
urlpatterns = [
    ...
    path("myfeed/<str:username>", views.indexFollowing, name="indexFollowing"),
    ...
    path("following/<str:username>", views.postFollowing, name="postsFollowing"),
